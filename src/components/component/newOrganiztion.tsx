      ...
      <DialogContent className="sm:max-w-[600px] bg-[#0e0e1f] text-white border-gray-700">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-between mt-4">
            {step > 1 && (
              <Button type="button" variant="outline" onClick={() => setStep(step - 1)} className="bg-gray-700 text-white hover:bg-gray-600">
                Back
              </Button>
            )}
            {step < 2 ? (
              ...
              <Button type="submit" className="bg-green-500 hover:bg-green-600">Create Organization</Button>
            )}
          </div>
        </form>
      </DialogContent>
